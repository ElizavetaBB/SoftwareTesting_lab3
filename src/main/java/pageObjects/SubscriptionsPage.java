...
public class SubscriptionsPage extends Page{
    ...
    @FindBy(xpath = "//*[@id=\"all\"]/section/div[2]/div/div/div[6]/div/div[3]/div[2]/div")
    private List<WebElement> mySubscriptions;
    ...
    public void unsubscribe() throws NullPointerException{
        WebElement ele = webDriver.findElement(By.xpath("//*[@id=\"all\"]/section/div[2]/" +
                "div/div/div[1]/div[4]/div/span[1]/a"));
